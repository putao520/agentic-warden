...
Agentic-Warden 是一个 AI CLI 工具的统一启动和管理工具，专为多 AI 环境下的开发工作流而设计。
...
**核心功能特性**:
- **进程状态跟踪**: 跟踪所有 AI CLI 进程状态和任务执行情况
...
- 集成式授权：push/pull 命令自动检测并触发 Device Flow 认证
