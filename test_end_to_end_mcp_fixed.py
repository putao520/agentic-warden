...
Respond with ONLY JSON, no markdown fences."""
    ...
    # 创建一个测试脚本，模拟工具注册
    # 使用普通字符串格式化，避免f-string中的嵌套括号问题
    tool_json_str = codex_result.stdout.strip()
...
print("🔧 注册工具: " + tool_data['name'])
print("📝 描述: " + tool_data['description'])
print("📋 Schema: " + str(tool_data.get('input_schema', {{}})))
...
if isinstance(schema, dict) and schema.get('type') == 'object':
    ...
    print("  属性数量: " + str(len(properties)))
    print("  必需参数: " + str(required))
    ...
    if missing_props:
        print("❌ 缺少必需属性: " + str(missing_props))
    else:
        print("✅ 所有必需属性都存在")
        ...
        if valid_input:
            ...
            if 'async function workflow' in js_code and 'mcp.call(' in js_code:
                ...
                print("🎯 基础语法检查: " + str(passed_checks) + "/5 通过")
